...
int main(void)
{
	...
	mocr::Sequential seq(1, 0.1);

	seq.addLayer(16, mocr::Activation::SIGMOID);
	seq.addLayer(1, mocr::Activation::SIGMOID);
	...
	// seq.addLayer(784, mocr::Activation::SIGMOID);
	// seq.addLayer(30, mocr::Activation::SIGMOID);
	...
	// 	auto raw = data[choice].first;
	// 	auto inp = mocr::resize(raw, 1, 28 * 28, 1);
	// 	auto exp = data[choice].second;
